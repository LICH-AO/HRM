...
<script type="text/javascript">
    ...
    $(function(){
    	...
    	$("#indexMain").click(function() {
    		parent.location = "${ctx}/indexMain.action";
		})
	...
	<td class="topbg">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <tr>
		  ...
		  <img src="${ctx}/images/top_home.gif">&nbsp;&nbsp;<a href="javascript:void(0);" id="indexMain">网站首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  <img src="${ctx}/images/top_exit.gif">&nbsp;&nbsp;<a href="javascript:void(0);" id="exit">注销退出</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>
		<tr>
