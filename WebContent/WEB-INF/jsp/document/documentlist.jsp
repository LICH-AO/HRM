			  ...
			  <td class="fftd">
			  	<form name="documentform" method="post" id="documentform" action="${ctx }/documentlist.action">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    <input type="hidden" name="pageNow" id="pageNow" value="${pb.pageNow }">
	  ...
	  <tr valign="top">
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${requestScope.pb.list}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" name="docIds" value="${document.id}">
					 ...
					 <td align="center" width="40px;"><a href="${ctx }/documentedit.action?flag=1&id=${document.id}">
